...
public class LinearAnimator extends Animator {
    ...
    public LinearAnimator(Animation animation) {
        this(animation, true);
    }

    public LinearAnimator(Animation animation, boolean loop) {
        this(animation, loop, true);
    }

    public LinearAnimator(Animation animation, boolean loop, boolean start) {
